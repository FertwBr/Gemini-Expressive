...
A powerful browser extension designed to supercharge the Google Gemini web interface. Gemini Expressive brings advanced
productivity tools, seamless code management, and beautiful, dynamic Material You theming directly to your workspace.

<div align="center">
  <img src="docs/media/hero-shot.png" alt="Gemini Expressive Hero Shot" width="100%">
</div>
...
* **Chat Search:** Quickly search through your current conversation context to pinpoint exactly what you need without
  endless scrolling.
* **Timeline Navigation:** Adds a sleek, floating timeline on the right side of the screen, allowing you to easily jump
  through long conversation threads.

![Timeline Navigation](docs/media/timeline-navigation.png)

![Prompt Snippets & Shortcuts](docs/media/prompt-snippets-&-shortcuts.png)

### 💻 Developer Tools

* **Code Block Collapser:** Keep your chat clean and save screen space by collapsing and expanding long code blocks with
  a single click.
...
![Smart Code Collapsing & Headers](docs/media/smart-code-collapsing-&-headers.png)
...
The extension settings and interface are fully localized in:
...
---
**Built by [Fernando Vaz (fertw)](https://github.com/fertwbr)** 🌐 [fertw.com](https://fertw.com) |
🛠️ [Gemini Expressive Official Page](https://tools.fertwbr.com/geminiexpressive)